...
<?php if ( $show_commissions_summary ) : ?>
	<div class="dashboard-title">
		<h3><?php esc_html_x( 'Recent Commissions', '[FRONTEND] Affiliate dashboard', 'yith-woocommerce-affiliates' ); ?></h3>
	...
	$table = new YITH_WCAF_Dashboard_Table(
		...
		array(
			'columns'      => array(
				...
				'affiliate_id'   => esc_html_x( 'Customer', '[FRONTEND] Dashboard table', 'yith-woocommerce-affiliates' ),
				'status'     => '',
			),
			'items'        => 'commissions',
